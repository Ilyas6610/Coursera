...
void TestIsPalindrom(){
    ...
    Assert(IsPalindrom("maaaaam"), "maaaaam");
    Assert(IsPalindrom("a"), "a");
    Assert(IsPalindrom("ada"), "ada");
    Assert(IsPalindrom("m m"), "m m");
    Assert(IsPalindrom(" m * m "), " m * m ");
    Assert(IsPalindrom("aaaaaa"), "aaaaaa");
    AssertFalse(IsPalindrom(" m m"), " m m");
    AssertFalse(IsPalindrom("--_-_-"), "");
    AssertFalse(IsPalindrom("League"), "League");
    AssertFalse(IsPalindrom("Dad"), "Dad");
}
